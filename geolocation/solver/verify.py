...
def verify_solution(sat_data = None,
                    roots = None, 
                    solution = None,
                    tdoa = None):
    """
...
def generate_TDOA(sat_data = None, 
    ...
    tdoa_clean = np.array([d_emitter[i+1] - d_emitter[0] for i in range(n_sats - 1)]) / constants.speed_of_light 
